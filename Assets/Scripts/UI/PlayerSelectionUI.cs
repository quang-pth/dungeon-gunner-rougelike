...
{
    #region Tooltip
    [Tooltip("Populate with the Sprite Renderer on child game object WeaponAnchorPosition/WeaponRotationPoint/Hand")]
    #endregion
    public SpriteRenderer playerHandSpriteRenderer;
    #region Tooltip
    [Tooltip("Populate with the Sprite Renderer on child game object HandNoWeapon")]
    #endregion
    public SpriteRenderer playerHandNoWeaponSpriteRenderer;
    #region Tooltip
    [Tooltip("Populate with the Sprite Renderer on child game object WeaponAnchorPosition/WeaponRotationPoint/Weapon")]
    #endregion
