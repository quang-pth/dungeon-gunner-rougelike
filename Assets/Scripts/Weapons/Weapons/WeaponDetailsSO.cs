...
public class WeaponDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Weapon shoot position - offset position for the end of the weapon from the sprite pivot point")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("The weapon reloading sound effect SO for the weapon")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("The ammo capacity - the maximum number of rounds that can be held for the weapon")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("The weapon fire rate - 0.2 means 5 shots a second")]
    #endregion Tooltip
    public float weaponFireRate = 0.2f;
    
    #region Tooltip
    [Tooltip("The weapon precharge time - time in seconds to hold fire button down before firing")]
    #endregion Tooltip
    public float weaponPrechargeTime = 0f;
    
    #region Tooltip
    [Tooltip("The weapon reload time in seconds")]
    #endregion Tooltip
